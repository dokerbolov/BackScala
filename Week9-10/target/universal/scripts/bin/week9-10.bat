@REM week9-10 launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM WEEK9_10_config.txt found in the WEEK9_10_HOME.
...
if "%WEEK9_10_HOME%"=="" (
  ...
  set "WEEK9_10_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%WEEK9_10_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\WEEK9_10_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running week9-10.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !WEEK9_10_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
